...
const Append_Produts = (data, location) => {
  ...
  data.forEach((el) => {
    ...
    img.src = el.mainimg;
    img_div.append(img);
    img_div.addEventListener("mouseenter", () => {
    ...
    //bottom combo div created here
    let combo_of_size_and_add_to_cart = document.createElement("div");
    combo_of_size_and_add_to_cart.className = "bottom_combo_div";
    ...
    //combo of size and add to cart div appeded here
    //css trying to give zIndex for this above div on hover
    combo_of_size_and_add_to_cart.append(combo_of_size_color_div, addtocart_btn_div)
    ...
    addtocart_btn.addEventListener("click", () => {
      ...
      alert(`${el.name} added inside basket`)
    ...
    one_product_div.append(img_div, price_div, name_div, combo_of_size_and_add_to_cart)
